...
import { Mail, Linkedin, Github, Code, Server, Cloud, Briefcase, Award, ChevronRight, Terminal, Zap, Cpu, Database } from 'lucide-react';
...
export default function Portfolio() {
  ...
  const skills = {
    ...
    frontend: ['React.js', 'React TypeScript', 'Vite', 'JavaScript', 'TypeScript', 'HTML', 'CSS'],
    backend: ['Python', 'Ignition Scripting'],
    tools: ['ChatGPT', 'Claude AI', 'Perplexity', 'Gemini'],
    specialized: ['Ignition Perspective', 'PLC/SCADA Integration', 'Industrial Automation']
  };

  const projects = [
    {
      title: 'Industrial Simulation Systems',
      description: 'Created animated simulations for manufacturing industries using PLC/SCADA sensor data in Ignition Perspective',
      tech: ['Ignition', 'SCADA', 'Animation'],
      icon: Cpu
    },
    {
      title: 'React Flow Chart Component',
      description: 'Developed hierarchical flow chart components with dual compatibility for JavaScript and TypeScript',
      tech: ['React', 'JavaScript', 'TypeScript'],
      icon: Terminal
    },
    {
      title: 'Gantt Chart Scheduling Tool',
      description: 'Built a comprehensive Gantt chart component for project scheduling and planning',
      tech: ['React', 'TypeScript', 'Scheduling'],
      icon: Database
    },
    {
      title: 'React Application Architecture',
      description: 'Led research and development of full-stack React applications from scratch, including CI/CD setup',
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:block">
                <div className="text-white font-bold text-lg tracking-tight">Prashant Vaghela</div>
          ...
          <div className="text-center space-y-8 relative z-10">
            <div className="inline-block">
              <div className="flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-cyan-400 text-sm">Available for opportunities</span>
              </div>
            </div>
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Architecting cutting-edge <span className="text-cyan-400 font-semibold">web solutions</span> and <span className="text-cyan-400 font-semibold">industrial automation systems</span> for next-generation manufacturing intelligence
            </p>

            <div className="flex justify-center gap-4 pt-8">
              {[
                { icon: Mail, color: 'from-cyan-500 to-blue-500' },
                { icon: Linkedin, color: 'from-blue-500 to-indigo-500' },
                { icon: Github, color: 'from-purple-500 to-pink-500' }
              ].map((item, i) => (
                <button
                  key={i}
                  className="relative group p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-cyan-500/50 transition-all"
                >
                  <item.icon className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" />
                  <div className={`absolute inset-0 rounded-xl bg-gradient-to-r ${item.color} opacity-0 group-hover:opacity-20 blur transition-opacity`} />
                </button>
              ))}
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20 relative z-10">
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl rounded-3xl p-8 border border-cyan-500/20 hover:border-cyan-500/40 transition-all">
              <div className="space-y-6">
                <p className="text-lg text-gray-300 leading-relaxed">
                  I'm a passionate <span className="text-cyan-400 font-semibold">Software Developer</span> with 2 years of experience at Leanqubit, specializing in creating innovative solutions for manufacturing intelligence. My expertise lies in bridging the gap between industrial automation and modern web technologies.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed">
                  I've successfully led teams in developing complex React applications, industrial simulation systems, and specialized components for project management. My work involves everything from PLC/SCADA integration to cloud infrastructure on AWS.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed">
                  As a <span className="text-cyan-400 font-semibold">technical leader</span>, I focus on architectural planning, research-driven development, and mentoring team members to deliver high-quality solutions that meet business objectives.
                </p>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-gray-300">
                      ...
                      <span className="font-semibold">Industrial Automation</span>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 text-gray-300">
            ...
            <div className="relative">
              ...
              <div className="ml-8 bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl rounded-3xl p-8 border border-cyan-500/20 hover:border-cyan-500/40 transition-all">
                <div className="flex items-start gap-4 mb-8">
                  ...
                  <div>
                    <h4 className="text-3xl font-bold text-white mb-2">Software Developer</h4>
                    <p className="text-cyan-400 font-medium text-lg">Leanqubit • 2 Years</p>
                    <div className="flex gap-2 mt-3">
                      <span className="px-3 py-1 bg-cyan-500/10 text-cyan-400 rounded-full text-xs border border-cyan-500/30">Full-Time</span>
                      <span className="px-3 py-1 bg-blue-500/10 text-blue-400 rounded-full text-xs border border-blue-500/30">Tech Lead</span>
                    </div>
                  </div>
                </div>
        ...
        {activeSection === 'skills' && (
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { title: 'Cloud & Infrastructure', skills: skills.cloud, icon: Cloud, gradient: 'from-cyan-500 to-blue-500' },
                { title: 'Frontend Development', skills: skills.frontend, icon: Code, gradient: 'from-green-500 to-emerald-500' },
                { title: 'Backend & Scripting', skills: skills.backend, icon: Server, gradient: 'from-purple-500 to-pink-500' },
                { title: 'AI & Tools', skills: skills.tools, icon: Zap, gradient: 'from-orange-500 to-red-500' }
              ].map((category, i) => (
                <div key={i} className="group relative bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl rounded-3xl p-6 border border-cyan-500/20 hover:border-cyan-500/40 transition-all">
                  <div className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${category.gradient} opacity-0 group-hover:opacity-10 blur-xl transition-opacity`} />
                  <div className="relative">
                    <div className="flex items-center gap-3 mb-6">
                      <div className={`p-3 bg-gradient-to-br ${category.gradient} bg-opacity-10 rounded-xl`}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {category.skills.map((skill) => (
                        <span key={skill} className="px-3 py-1.5 bg-white/5 text-gray-300 rounded-lg text-sm border border-cyan-500/20 hover:border-cyan-500/50 hover:text-cyan-400 transition-all cursor-default">
                          {skill}
                        </span>
                      ))}
                    </div>
              ...
              <div className="md:col-span-2 group relative bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl rounded-3xl p-6 border border-cyan-500/20 hover:border-cyan-500/40 transition-all">
                ...
                <div className="relative">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h4 className="text-xl font-semibold text-white">Specialized Expertise</h4>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {skills.specialized.map((skill) => (
                      <span key={skill} className="px-4 py-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 text-cyan-400 rounded-lg text-sm border border-cyan-500/30 hover:border-cyan-500/60 hover:shadow-lg hover:shadow-cyan-500/20 transition-all cursor-default">
                        {skill}
                      </span>
                    ))}
                  </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {projects.map((project, i) => (
                <div key={i} className="group relative bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl rounded-3xl p-8 border border-cyan-500/20 hover:border-cyan-500/50 transition-all hover:scale-105">
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-cyan-500 to-blue-500 opacity-0 group-hover:opacity-10 blur-xl transition-opacity" />
                  <div className="relative">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.map((tech) => (
                        <span key={tech} className="px-3 py-1 bg-white/5 text-gray-400 rounded-lg text-xs border border-white/10 group-hover:border-cyan-500/30 transition-all">
                          {tech}
                        </span>
                      ))}
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              <div className="text-white font-bold text-lg mb-2">Prashant Vaghela</div>
